...
function getOptions(_ref, opts) {
  ...
  if (_lodash2.default.isObject(config.mathjax)) {
    ...
    if (!_lodash2.default.isObject(config.math)) config.math = { mathjax: config.mathjax };
  }

  opts = _lodash2.default.defaultsDeep({}, opts, config.math, DEFAULT_OPTS);
